...
![Pixel art rendered in REAPER](image.png)
...
| `minesweeper_reaper.lua` | Bonus: Minesweeper game inside REAPER |
| `LICENSE` | MIT |

## Bonus: Minesweeper

`minesweeper_reaper.lua` is a fully playable Minesweeper built with REAPER's `gfx` API. 16×16 grid, 32 mines, flood fill, safe first click. Requires js_ReaScriptAPI.
